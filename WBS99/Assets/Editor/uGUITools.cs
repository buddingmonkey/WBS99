...
public class uGUITools : MonoBehaviour {
	...
	static void MirrorHorizontallyAnchors(){
		Undo.RecordObjects (Selection.transforms, "Mirror Horiz Around Anchors");
		MirrorHorizontally(false);
	}

	[MenuItem("uGUI/Mirror Horizontally Around Parent Center %:")]
	static void MirrorHorizontallyParent(){
		Undo.RecordObjects (Selection.transforms, "Mirror Horiz Around Parent");
	...
	static void MirrorVerticallyAnchors(){
		Undo.RecordObjects (Selection.transforms, "Mirror Vert Around Anchors");
		MirrorVertically(false);
	}
	
	[MenuItem("uGUI/Mirror Vertically Around Parent Center %\"")]
	static void MirrorVerticallyParent(){
		Undo.RecordObjects (Selection.transforms, "Mirror Vert Around Parent");
